...
export default function Services() {
  return (
    <div className="target2 h-full block">
      <h1 className="text-center font-normal sm:text-6xl h-1/12 text-4xl underline decoration-2 underline-offset-[16px] md:py-14 pt-14">
        Geschäftsbereiche
      </h1>
      <div className="grid xl:grid-cols-4 lg:grid-cols-2 grid-cols-1 gap-2 h-11/12 py-6 px-10 mx-auto place-items-center container">
        ...
        <div className="border-2 xl:h-5/6 w-full my-6 bg-[#272829] text-zinc-200 shadow-md rounded-md flex flex-col place-items-center content-center ">
          ...
          <p className="text-center  h-1/4 flex justify-center items-center lg:text-lg text-base font-normal ">
        ...
        <div className="border-2 xl:h-5/6 w-full my-6 bg-[#272829] text-zinc-200 shadow-md rounded-md flex flex-col place-items-center content-center ">
          ...
          <p className="text-center h-1/4 flex justify-center items-center container lg:text-lg text-base font-normal">
            Tiefe und Flache
