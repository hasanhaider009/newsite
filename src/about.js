...
export default function About(){
    ...
    return(
        <div className="max-h-fit bg-no-repeat bg-cover bg-fixed text-black text-[#D8D9DA] target2">
            ...
            <p className="text-sm xl:text-xl lg:text-lg md:text-base font-normal text-justify block sm:pr-8 w-auto md:max-w-[50vw] md:order-1 order-2 justify-center content-center md:pb-0 pb-6 flex flex-col">
