...
export default function DismissableModal4() {
  ...
  return (
    <>
      <div className="rounded-lg border-2 md:col-span-1 col-span-6 text-xs text-zinc-800 border-emerald-50 bg-zinc-200 text-slate-800 px-2 py-1 sm:py-2 max-h-14 self-center hover:bg-red-600 hover:text-zinc-200 ease-in duration-200 drop-shadow-md cursor-pointer" onClick={() => props.setOpenModal('dismissible')}>Mehr Lesen</div>
