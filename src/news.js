...
export default function News(){
    return(
        ...
        <h2 className="text-center font-normal max-h-[20vh] sm:pb-10 pb-2 text-black sm:text-6xl text-4xl underline decoration-2 underline-offset-[16px] md:pt-16 pt-4">News</h2>
        <Swiper
